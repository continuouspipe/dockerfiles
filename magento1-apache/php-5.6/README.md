...
## How to build
```bash
docker-compose build magento1_apache
docker-compose push magento1_apache
```

## About

This is a Docker image that can install and serve a Magento 1 installation via Apache and PHP 7.
