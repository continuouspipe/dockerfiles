...
find "$DIR" \( -name "*.sh" -or -name "*_env_variables" -or -name "supervisor*_start" \) -exec shellcheck --exclude SC1091 {} +
find "$DIR" -name "Dockerfile" -exec hadolint --ignore DL3008 --ignore DL3002 {} \;
